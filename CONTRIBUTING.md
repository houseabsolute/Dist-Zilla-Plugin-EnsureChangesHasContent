...
https://metacpan.org/release/Dist-Zilla-Plugin-EnsureChangesHasContent

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Dist::Zilla::Plugin::EnsureChangesHasContent
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Dist::Zilla::Plugin::EnsureChangesHasContent
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Dist-Zilla-Plugin-EnsureChangesHasContent)
or [via email](bug-dist-zilla-plugin-ensurechangeshascontent@rt.cpan.org.
